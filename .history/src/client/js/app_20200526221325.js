...
const updateUI = (cityFrom, cityTo, weatherData, date, dayDiff) => {
    console.log(`Your're going from ${cityFrom} to ${cityTo} on ${date} in ${dayDiff} days, and the weather's gonna be like ${weatherData.weather.description}, with the temperature going as high as ${weatherData.high_temp}`)
